...
export default function CallToAction() {
  return (
    <div className='flex flex-col lg:flex-row gap-5 p-7 border-light-green-800 border-2 rounded-tl-[30px] rounded-br-[30px] my-5'>
        <div className='space-y-3 flex-1 lg:order-1 order-2 flex flex-col  justify-center'>
